...
<template>
  <div class="relative bg-slate-900 border border-slate-800 rounded-2xl p-5 sm:p-6 space-y-5 shadow-xl">
    ...
    <Modal
      ...
      title="Calorie Expenditure & Target"
      :icon="Flame"
      ...
      <form @submit.prevent="handleSaveTarget" class="space-y-4">
        ...
        <div class="space-y-1.5">
          ...
          <div class="grid grid-cols-3 gap-2">
            <button
              type="button"
              @click="selectGoalPreset('deficit')"
              :class="[
            ...
            <button
              type="button"
              @click="selectGoalPreset('maintenance')"
              :class="[
                'p-2 rounded-xl border text-center transition cursor-pointer text-xs font-medium',
            ...
            <button
              type="button"
              @click="selectGoalPreset('surplus')"
              :class="[
                'p-2 rounded-xl border text-center transition cursor-pointer text-xs font-medium',
        ...
        <div class="space-y-1.5 pt-1">
          ...
          <input
            ...
            inputmode="numeric"
            pattern="[0-9]*"
            v-model.number="inputTargetCal"
            @input="selectedGoalMode = 'custom'"
            required
