...
import type { UserFavoriteTemplate, FoodTemplate, Micronutrients } from '../../../types/fitness'
...
<template>
  <div class="space-y-4">
    ...
    <div class="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3">
      <div class="relative flex-1">
        ...
        <input
          type="text"
          v-model="searchQuery"
          placeholder="Filter favorite foods..."
    ...
    <div v-else-if="filteredFavorites.length > 0" class="grid grid-cols-1 md:grid-cols-2 gap-3">
      ...
      >
        <div class="flex items-start justify-between gap-2">
          ...
          <button
            type="button"
            @click="emit('toggle-favorite', fav.template_id)"
    ...
    <!-- Log Favorite Modal -->
    <Modal
      v-if="loggingFavorite"
      title="Log Favorite Food"
      :icon="Utensils"
      icon-color="text-amber-400"
      max-width-class="max-w-md"
      @close="loggingFavorite = null"
    >
      <div class="space-y-5">
        ...
        <div class="p-3 rounded-xl bg-amber-500/10 border border-amber-500/20 text-xs flex items-center justify-between text-amber-200">
    ...
    <NutritionBreakdownModal
      :show="!!inspectedTemplate"
      :data="inspectedTemplate ? {
